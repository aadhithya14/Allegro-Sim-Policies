...
from allegro_sim.utils import get_inverse_image_norm
...
class Rewarder(ABC):
    ...
    def get_representations(self, obs, debug=True): 
        ...
        if debug:
            ...
            print("Expert demos ", self.expert_demos)
